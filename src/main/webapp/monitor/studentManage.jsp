...
<div id="func">
    ...
    <span class="func-block">
            按姓名查询：<input id="student-name" maxlength="6" type="text">
            <label><input id="student-name-submit" type="button" value="提交"></label>
        </span>
    <span class="func-block">
            按条件查询：
...
<script type="application/javascript">
    ...
    $('#student-name-submit').click(function(){
        var data={'Sname':$('#student-name').val()};
